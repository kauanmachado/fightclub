        ...
        <footer className="flex flex-col md:flex-row justify-center md:items-center w-full gap-6 p-8 md:p-16 bg-gray-900 text-gray-300">
            ...
            <div className="flex flex-col md:flex-1">
                ...
                <ul className="gap-6">
                    <li>
                        <Link href="/">
                            <Linkedin size={30} className="text-white hover:text-orange-700 transition-all mb-2"/>
                        </Link>
                        <Link href="/">
                            <Github size={30} className="text-white hover:text-orange-700 transition-all"/> 
                        </Link>
                    </li>
                </ul>
